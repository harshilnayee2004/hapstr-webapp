    ...
    >
      ...
      <section className="lm-hero relative overflow-hidden">
        ...
        <div className="lm-hero-inner relative z-10">
          ...
          <div className="lm-hero-text">
            ...
            <h1 className="lm-h1">
              Triayam transforms real&nbsp;estate into an{" "}
              <em className="lm-h1-em">interactive</em>{" "}
              3D&nbsp;experience.
            </h1>

            <p className="lm-sub">
              Click the cards to explore what Triayam can do for you.
            </p>
      ...
      <section className="lm-grid-section">
        ...
        <div className="lm-grid-header">
          ...
          <p className="lm-grid-sub">A visual overview of Triayam&apos;s capabilities.</p>
        </div>
